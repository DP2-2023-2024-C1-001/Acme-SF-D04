...
<acme:form>
	<acme:input-textbox code="any.progress-log.form.label.code" path="code"/>	
	<acme:input-double code="any.progress-log.form.label.completeness" path="completeness" placeholder="any.progress-log.form.placeholder.completeness"/>
