...
<acme:form>
	...
	<acme:input-moment code="sponsor.sponsorship.form.label.initialDate" path="initialDate"/>
	<acme:input-moment code="sponsor.sponsorship.form.label.finalDate" path="finalDate"/>
